...
extension MyExtension on List<Song> {
  String totalTime() {
    ...
    if (minutes > 60) {
      ...
      minutes = minutes % 60;
      text =
          '\nTotal duration $hours:$minutes:${seconds < 10 ? '0$seconds' : '$seconds'}\n';
    } else {
      text =
          '\nTotal duration $minutes:${seconds < 10 ? '0$seconds' : '$seconds'}\n';
    }
    return text;
  }
}
...
const mySongs = [
  ...
  Song(
      ...
      duration: '8:01',
      year: '2021'),
  Song(name: 'G.S.K.', artist: 'Squid', duration: '3:11', year: '2021'),
  Song(name: 'Narrator', artist: 'Squid', duration: '8:29', year: '2021'),
  Song(name: 'Boy Racers', artist: 'Squid', duration: '7:34', year: '2021'),
  Song(name: 'Padding', artist: 'Squid', duration: '6:17', year: '2021'),
  Song(
      name: 'Documentary Filmmaker',
      artist: 'Squid',
      duration: '4:56',
      year: '2021'),
  Song(name: '2010', artist: 'Squid', duration: '4:28', year: '2021'),
  Song(name: 'The Flyover', artist: 'Squid', duration: '1:11', year: '2021'),
  Song(name: 'Peel St.', artist: 'Squid', duration: '4:52', year: '2021'),
  Song(name: 'Global Groove', artist: 'Squid', duration: '5:08', year: '2021'),
  Song(name: 'Pamphlets', artist: 'Squid', duration: '8:04', year: '2021'),
  Song(
      name: 'Holiday Destination',
      artist: 'Nadine Shah',
      duration: '5:39',
      year: '2017'),
  Song(name: '2016', artist: 'Nadine Shah', duration: '4:47', year: '2017'),
  Song(
      name: 'Out the Way',
      artist: 'Nadine Shah',
      duration: '3:48',
      year: '2017'),
  Song(name: 'Evil', artist: 'Nadine Shah', duration: '5:00', year: '2017'),
  Song(
      name: 'Aching Bones',
      artist: 'Nadine Shah',
      duration: '3:55',
      year: '2013'),
  Song(name: 'Trad', artist: 'Nadine Shah', duration: '5:28', year: '2020'),
  Song(
      name: 'Kitchen Sink',
      artist: 'Nadine Shah',
      duration: '3:27',
  ...
  Song(
      ...
      duration: '3:43',
      year: '2021'),
  Song(name: 'Ducter', artist: 'black midi', duration: '6:42', year: '2019'),
];
